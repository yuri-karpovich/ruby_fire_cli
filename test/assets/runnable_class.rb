...
# Nothing special here except @runnable tag. This is a `ruby_fire_cli` tag that
...
# Instance action requires #initialize method to be executed first. `ruby_fire_cli` tool invokes #initialize
